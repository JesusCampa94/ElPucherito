...
public void CambiarNoticia (NoticiaEN noticia)
{
        try
        {
                SessionInitializeTransaction ();
                ...
                noticiaEN.Etiquetas = noticia.Etiquetas;


                noticiaEN.FechaCrea = noticia.FechaCrea;


                noticiaEN.Contenido = noticia.Contenido;


                noticiaEN.Likes = noticia.Likes;


                noticiaEN.Visualizaciones = noticia.Visualizaciones;
